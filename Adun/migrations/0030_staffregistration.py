# Generated by Django 4.2.3 on 2023-08-23 23:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Adun', '0029_remove_patientregistration_password_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password1', models.CharField(max_length=30, null=True, unique=True)),
                ('password2', models.CharField(max_length=30, null=True, unique=True)),
                ...
                ('faculty', models.CharField(choices=[('fos', 'Faculty of Science'), ('fams', 'Faculty of Arts and Management Science'), ('fol', 'Faculty of Law')], max_length=10, null=True)),
